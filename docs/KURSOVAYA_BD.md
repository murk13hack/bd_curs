...
>
> **Файл для вставки:** `docs/diagrams/png/09-olap-star.png` (готов (PNG в репозитории)).
...
>
> **Скриншот (вставить вручную):** страница «Статистика» → блок OLAP (localhost после docker compose up).
...
>
> **Файл для вставки:** `docs/diagrams/png/11-explain-q1-calendar.png` (готов (PNG в репозитории)).
...
>
> **Файл для вставки:** `docs/diagrams/png/12-explain-q2a-q2b-diary.png` (готов (PNG в репозитории)).
...
>
> **Файл для вставки:** `docs/diagrams/png/13-explain-q3-tasks-index.png` (готов (PNG в репозитории)).
